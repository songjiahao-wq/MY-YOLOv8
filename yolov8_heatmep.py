...
if __name__ == '__main__':
    for layer_id in range(5,20):
        model = yolov8_heatmap(**get_params(layer_id=layer_id))
        model(r'ultralytics/assets/bus.jpg', f'result/{layer_id}')